...
const DIM_DETAIL = {
  ...
  "居住・利便性": {
    ...
    color: "#2d7040",
    indicators: [
      { name: "自動車保有台数（公共交通依存度の代理）", source: "自動車検査登録情報協会", year: "2014", note: "低いほど高スコア（逆転）" },
    ...
    why: "住居の広さ・所有安定性・家賃・全体物価・公共交通利便性を統合評価。居住コストの多面的な側面を捉える。",
  },
  "環境・安全": {
    title: "環境・安全",
    color: "#b07818",
    indicators: [
      ...
      { name: "犯罪発生率（人口10万対）", source: "警察庁 犯罪統計", year: "2024", note: "低いほど高スコア（逆転）" },
      { name: "交通事故発生率（人口10万対）", source: "警察庁 交通統計", year: "2023", note: "低いほど高スコア（逆転）" },
    ],
